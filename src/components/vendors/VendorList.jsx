...
import { Search, Trash2, Star, Eye, Trash, CircleCheckBig, Ban, CircleAlert, CircleX, XCircle } from "lucide-react";
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
        {[
          {
            label: "Total Vendors",
            value: transformedVendors.length,
            icon: Users,
            bg: "bg-blue-200",
          },
          {
            label: "Active",
            value: transformedVendors.filter((v) => v.status === "Active").length,
            icon: UserCheck,
            bg: "bg-green-200",
          },
          {
            label: "Blacklisted",
            value: transformedVendors.filter((v) => v.status === "Blacklisted").length,
            icon: ShieldAlert,
            bg: "bg-purple-200",
          },
                      ...
                      >
                        ...
                        <td className="py-3">
                          <div className="flex items-center gap-1 text-gray-800">
                            {vendor.rating > 0 ? vendor.rating.toFixed(1) : 0}
              ...
              <div className="block md:hidden mt-5 space-y-4">
                {filteredVendors.map((vendor) => (
                  ...
                  >
                    ...
                    <div className="text-sm mb-1">
                      <strong>📄 Total Jobs:</strong> {vendor.totalJobsApplied || 0}
                    </div>
